...
resource "aws_lambda_function" "lambda_landing" {
    ...
    image_uri = "631204218401.dkr.ecr.eu-west-2.amazonaws.com/demo/load-amplify:test"
    package_type = "Image"
...
resource "aws_lambda_function" "lambda_db" {
    ...
    image_uri = "631204218401.dkr.ecr.eu-west-2.amazonaws.com/demo/database:test"
    package_type = "Image"
    role = aws_iam_role.iam_lambda.arn
    tags = {
        environment = var.environment
...
resource "aws_lambda_function" "lambda_dl" {
    ...
    image_uri = "631204218401.dkr.ecr.eu-west-2.amazonaws.com/demo/datalake:test"
    package_type = "Image"
    role = aws_iam_role.iam_lambda.arn
    tags = {
        environment = var.environment
